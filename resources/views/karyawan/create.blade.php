...
<div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-lg">
    ...
    <form action="{{ route('karyawan.store') }}" method="POST">
        ...
        <div class="bg-gray-50 p-4 rounded mb-6 border border-gray-200">
            ...
            <input type="text" name="nama" class="w-full p-2 border rounded focus:ring-blue-500 focus:border-blue-500" required>
            
            <label class="block text-gray-700 text-sm font-bold mt-3 mb-2">Jabatan</label>
            <input type="text" name="jabatan" class="w-full p-2 border rounded focus:ring-blue-500 focus:border-blue-500">
        </div>

        <h3 class="text-lg font-semibold mb-4 text-gray-700 border-b pb-2">Input Penilaian</h3>
        ...
        <div class="mt-8 flex gap-3">
            <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded font-bold hover:bg-blue-700 shadow transition">Simpan Data</button>
